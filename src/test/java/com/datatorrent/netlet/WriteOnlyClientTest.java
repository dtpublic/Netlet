...
public class WriteOnlyClientTest
{
  ...
  public void keyInteresetOps() throws Exception
  {
    final WriteOnlyClient writeOnlyClient = connect(OP_READ);
    final SelectionKey key = writeOnlyClient.key;
    assertNotSame(this.key, key);
    assertSame(key, key.interestOps(OP_WRITE));
